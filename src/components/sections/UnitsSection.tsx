...
const towers = [
  { name: "Metro Tower", lifts: "3 Passenger Lifts + 1 Service Lift" },
  { name: "Horizon Tower", lifts: "4 Passenger Lifts + 1 Service Lift" },
  { name: "Apex Tower", lifts: "3 Passenger Lifts + 1 Service Lift" },
];
...
export function UnitsSection({ showHero = false }: UnitsSectionProps) {
  return (
    <>
      {showHero && (
      ...
      {/* Tower Overview */}
      <section id="units" className="py-16 bg-muted scroll-mt-20">
