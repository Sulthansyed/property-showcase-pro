          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Experience the perfect blend of Harmony, Oasis, Modernisation, and Enclave 
                  (H.O.M.E) - a prime, mature, and well-planned exclusive township nestled in 
                  106 acres of lush greenery at Taman Tasik Shah Alam.
                </p>
              </div>
            </div>
            <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  After delivering on this promise, we extended that pledge to the Klang Valley, 
                  and from there, we took our promise to more locations. Today, we have 
                  developments not just in Perak and the Klang Valley, but in Negeri Sembilan 
                  and Malacca as well.
                </p>
                <p>
                  ...
                  We continue to nurture our commitment to delivering high quality and innovative 
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Collaborating with industry-leading professionals
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-card p-8 rounded-lg shadow-card">
              ...
              <p className="text-secondary font-medium mb-4">IO Architects Sdn Bhd</p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                A team of young, highly-driven, passionate Architects established since 2023. 
                Experienced in mixed-development projects, commercial malls, office buildings, 
                transit-oriented development, retail parks, resorts, and high-rise apartments.
              </p>
            </div>
            <div className="bg-card p-8 rounded-lg shadow-card">
              <h3 className="font-display text-xl font-semibold text-foreground mb-3">
              ...
              <p className="text-secondary font-medium mb-4">WDI Design Sdn Bhd</p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Incorporated in February 2002 with over 21 years of experience and 130+ 
                completed projects in Malaysia. Design philosophy centers on finding the 
                balance between organic shapes and textures found in nature.
              </p>
            </div>
          </div>
        </div>
