          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Immerse yourself in a vibrant community where personal wellness meets 
                shared moments, blending nature with meaningful connections. Our podium 
                facilities are designed to cater to all ages and lifestyles.
              </p>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <p className="font-display text-2xl font-bold text-primary">50m</p>
                  <p className="text-sm text-muted-foreground">Olympic Lap Pool</p>
                </div>
                <div className="bg-muted p-4 rounded-lg">
                  <p className="font-display text-2xl font-bold text-primary">5</p>
                  <p className="text-sm text-muted-foreground">Security Tiers</p>
                </div>
                <div className="bg-muted p-4 rounded-lg">
