      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button variant="outline" asChild>
              <Link to="/amenities">Explore Facilities</Link>
            </Button>
            <Button variant="outline" asChild>
              <Link to="/location">Check Location</Link>
            </Button>
            <Button variant="outline" asChild>
      ...
      <section className="py-8 bg-card border-t border-border">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            Actual product may differ. This website does not form part of any contract. While every 
            effort has been made to ensure accuracy, no liability is accepted for any errors or 
            omissions. Prospective purchasers should seek independent professional advice before 
            making any purchase decision. The floor area stated is approximate and measured from 
            the center of the party wall.
          </p>
        </div>
      </section>
    </Layout>
